...
| 이름                                                                                      | 설명                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <code>supabase</code>,<br><code>supabase&#8209;postgres&#8209;best&#8209;practices</code> | Supabase 공식 플러그인. skill 2개와 MCP 서버(`https://mcp.supabase.com/mcp`)를 함께 제공 — `supabase`는 Database·Auth·Edge Functions·Realtime·Storage 작업 시 학습 데이터 대신 changelog와 공식 문서를 먼저 조회하게 하고 수정 뒤 테스트 쿼리로 검증까지 요구하며, `supabase-postgres-best-practices`는 Supabase 밖 Postgres에도 적용되는 8개 카테고리 규칙(스키마 설계·마이그레이션·RLS 정책과 그 성능·인덱스·커넥션 풀링·pgvector·느린 쿼리 진단)을 담음([supabase-plugin](https://github.com/supabase-community/supabase-plugin)) |
